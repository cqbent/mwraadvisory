...
<main id="main" class="site-main" role="main">
		       ...
		       /*
				$most_popular_args = array('post_type'=> 'cpt-library', 'posts_per_page'=> 7,'order'=>'ASC',
						...
						*/			  
						...
						{
							echo '<ul class="libraries-tag-list" style="width:100% !important"> ';	
		...
		?>
			...
			<?php } else{ ?>
				...
				<a class="fancybox-pdf" href="<?php echo $pdf_attatchment ?>" ><img src="<?php echo $library_thumbnail; ?>" /></a>
					...
					if($library_category->cat_ID == '132'){	
						...
						<?php if($library_type == 'video'){?>			
        					...
        					<h4 style="font-size: 13px;left;width: 220px;word-break: initial; padding-top:17px;"><?php echo $latest_post->post_title; ?></h4>
            		     	<?php } else{ ?>
                				<a href="<?php echo $pdf_attatchment ?>" class="fancybox-pdf"><img src="<?php echo $library_thumbnail; ?>" style="height:250px;width:200px;"/></a>
                       ...
                       <?php 
						...
						<li style='float:right; margin-top:75px;width:10%'><a onclick="window.location.href='<?php echo get_category_link($library_category->term_id ).'#category_content'?>'; return false;" href='#' style='color:white; width:120px; background-color:red; padding:6px; font-size:14px;'>See All</a></li>
