                    ...
                    <tr>
                        <td colspan="2">
                           ...
                           <!--<input type="button" name="calculat_rate" value="Calculate Rate" class="Calculate Rate"style="width:150px;height:50px;font-size: 17px !important;color:#000;font-weigth:bold" />-->
                            ...
                            <input id="rate_calculation_way_water" type="hidden" name="rate_calculation_way_water" value="" />
                             <input id="rate_calculation_way_sewer" type="hidden" name="rate_calculation_way_sewer" value="" />
                           ...
                           <input id="water_rate_table" type="hidden" name="water_rate_table" value="" />
                            <input id="sewer_rate_table" type="hidden" name="sewer_rate_table" value="" />
                           
                         
                           <input id="water_rate_table_part1" type="hidden" name="water_rate_table_part1" value="" />
                            <input id="water_rate_table_part2" type="hidden" name="water_rate_table_part2" value="" />
                            
                             <input id="sewer_rate_table_part1" type="hidden" name="sewer_rate_table_part1" value="" />
                             <input id="sewer_rate_table_part2" type="hidden" name="sewer_rate_table_part2" value="" />
                           ...
                           <input id="cumulative" type="hidden" name="cumulative" value="" />
                            ...
                            <input id="water_additional_fee_table" type="hidden" name="water_additional_fee_table" value="" />
                             <input id="sewer_additional_fee_table" type="hidden" name="sewer_additional_fee_table" value="" />
                             
                             <input id="water_base_administrator_meter_fee" type="hidden" name="water_base_administrator_meter_fee" value="" />
                              <input id="sewer_base_administrator_meter_fee" type="hidden" name="sewer_base_administrator_meter_fee" value="" />
                              
                              <input id="water_minimum_fee_include" type="hidden" name="water_minimum_fee_include" value="" />
                              <input id="sewer_minimum_fee_include" type="hidden" name="sewer_minimum_fee_include" value="" />
                              
                              
                            <input id="has_minimum_charage_bill_water_active" type="hidden" name="has_minimum_charage_bill_water_active" value="" />
                            <input id="has_minimum_charage_bill_sewer_active" type="hidden" name="has_minimum_charage_bill_sewer_active" value="" />
                              
                              
                              <input id="water_minimum_fee_includes_uses" type="hidden" name="water_minimum_fee_includes_uses" value="" />
                              <input id="sewer_minimum_fee_includes_uses" type="hidden" name="sewer_minimum_fee_includes_uses" value="" />
                              
                              
                              
                              <input id="water_minimum_fee_include_amount" type="hidden" name="water_minimum_fee_include_amount" value="" />
                              <input id="sewer_minimum_fee_include_amount" type="hidden" name="sewer_minimum_fee_include_amount" value="" />
                              
                               <input id="community_water_use_same_rate_year" type="hidden" name="community_water_use_same_rate_year" value="" />
                              <input id="community_sewer_use_same_rate_year" type="hidden" name="community_sewer_use_same_rate_year" value="" />
                              
                              
                              <input id="billing_month_when_same_rate_year" type="hidden" name="billing_month_when_same_rate_year" value="" />
                              
                               <input id="reaming_billing_month" type="hidden" name="reaming_billing_month" value="" />
                           
                             
                              
                              <input id="sewer_base_fee" type="hidden" name="sewer_base_fee" value="0.00" />
                               <input id="water_base_fee" type="hidden" name="water_base_fee" value="0.00" />
...
jQuery('#community-box,#year-box').change(function(){
 ...
 success : function(data){
  ...
  var water_minimum_fee_includes_uses = json['73'];
  var sewer_minimum_fee_includes_uses = json['74'];
  ...
  if(water_base_fee == ""){
   ...
   if(community_water_use_same_rate_year == 'No'){
  ...
  if(community_sewer_use_same_rate_year == 'No'){
...
if(community_water_use_same_rate_year == 'No'){
    ...
    if(jQuery('#community-box').val() == "ST. PAUL111")
   {
    ...
    console.log('billing_frequency_part1='+billing_frequency_part1);
    console.log('billing_frequency_part2='+billing_frequency_part2);
   ...
   // var water_usages_part2 = ((water_usages/12)*billing_frequency_part2)/billing_frequency;
    ...
    // alert('water_usage_part1='+water_usage_part1);
    // alert('water_usages_part2='+water_usages_part2);
    // alert('water_usages='+water_usages);
    ...
    var water_bill_result_part2 = calculate_rate_func(range_array[1],range_value_array[1],max_range_part2,billing_frequency_part2,base_fee,water_usages_part2,water_additional_fee_table,water_rate_type,has_community_minimum_fee_water,water_minimum_fee_include_amount,water_minimum_fee_includes_uses);
      ...
      if(jQuery('#community-box').val() == "ST. PAUL"){
           ...
           water_bill_result = ((billing_frequency*base_fee)+ (water_bill_result_part1 + water_bill_result_part2 )).toFixed(2);
...
function calculate_rate_func(range_array,range_value_array,max_range,billing_frequency,base_fee,water_usages,additional_fee_table,sewer_water_rate_type,has_community_minimum_fee,minimum_fee_amount,minimum_fee_includes_uses){
    ...
    // alert(range_value_array);
     //alert('max_range='+max_range);
    // alert(billing_frequency);
    // alert(base_fee);
    // alert(water_usages);
    // alert(additional_fee_table);
    // alert(jQuery('#community-box').val());
        ...
        if(jQuery('#community-box').val() == "ST. PAUL1111")
                {
