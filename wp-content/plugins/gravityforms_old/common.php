...
<IfModule mod_php5.c>
  php_flag engine off
	 ...
	 */
	public static function get_field_input( $field, $value = '', $lead_id = 0, $form_id = 0, $form = null, $customize=0 ) {
		...
		switch ( $type ) {
			...
			case 'honeypot':
				...
				if($customize==1)
				{
					return "<div class='ginput_container'></div>";
				}
				else
				{
			...
			default :
				...
				//Customized line
				return $field->get_field_input( $form, $value, $lead, $customize );
				break;
