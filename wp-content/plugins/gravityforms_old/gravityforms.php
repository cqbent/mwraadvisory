...
class GFForms {
	...
	public static function process_exterior_pages() {
		...
		switch ( $page ) {
			...
			case 'entry_view': //Customized line
				require_once( GFCommon::get_base_path() . '/entry_view.php' );
				break;
		}
		exit();
	}
...
SET d.value = l.value"
	 ...
	 * @uses GFCommon::get_base_path()
	 */
	public static function get_form( $form_id, $display_title = true, $display_description = true, $force_display = false, $field_values = null, $ajax = false, $tabindex = 1, $lead, $customize=0 ) {
		require_once( GFCommon::get_base_path() . '/form_display.php' );
		
		//Customized line
		return GFFormDisplay::get_form( $form_id, $display_title, $display_description, $force_display, $field_values, $ajax, $tabindex, $lead, $customize );
	}
