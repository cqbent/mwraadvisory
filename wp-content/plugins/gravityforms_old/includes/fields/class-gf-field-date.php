		...
		if ( $is_form_editor ) {
			...
			switch ( $field_position ) {
				case 'dmy' :
					...
					if($customize==1)
					{
						$date_inputs = $day_field . $month_field . $year_field;
					}
					else
					{
				...
				case 'ymd' :
					...
					if($customize==1)
					{
						$date_inputs = $year_field . $month_field . $day_field;
					}
					else
					{
				...
				default :
					...
					if($customize==1)
					{
						$date_inputs = $month_field . $day_field . $year_field;
					}
					else
					{
				...
				switch ( $field_position ) {
					...
					case 'dmy' :
						...
						if ( $date_type == 'datedropdown' ) {							
							...
							if($customize==1)
							{
								$field_str = "<div class='clear-multi'><div class='gfield_date_dropdown_day ginput_container ginput_container_date' id='{$field_id}_2_container'>".$day_value."</div>";
	
								$tabindex = $this->get_tabindex();
	
								$field_str .= "<div class='gfield_date_dropdown_month ginput_container ginput_container_date' id='{$field_id}_1_container'>".$month_value."</div>";
	
								$tabindex = $this->get_tabindex();
	
								$field_str .= "<div class='gfield_date_dropdown_year ginput_container ginput_container_date' id='{$field_id}_3_container'>".$year_value."</div></div>";
							}
							else
							{
					...
					case 'ymd' :
						...
						if ( $date_type == 'datedropdown' ) {
							...
							if($customize==1)
							{
								$field_str = "<div class='clear-multi'><div class='gfield_date_dropdown_year ginput_container ginput_container_date' id='{$field_id}_3_container'>".$year_value."</div>";
								...
								$field_str .= "<div class='gfield_date_dropdown_day ginput_container ginput_container_date' id='{$field_id}_2_container'>".$day_value."</div></div>";
					...
					default :
						...
						if ( $date_type == 'datedropdown' ) {
							...
							if($customize==1)
							{
								$field_str = "<div class='clear-multi'><div class='gfield_date_dropdown_month ginput_container ginput_container_date' id='{$field_id}_1_container'>".$month_value."</div>";
	
								$tabindex = $this->get_tabindex();
	
								$field_str .= "<div class='gfield_date_dropdown_day ginput_container ginput_container_date' id='{$field_id}_2_container'>".$day_value."</div>";
