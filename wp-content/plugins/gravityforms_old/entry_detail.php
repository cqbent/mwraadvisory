	...
	public static function lead_detail_grid( $form, $lead, $allow_display_empty_fields = false ) {
		...
		jQuery( document ).ready(function() {
		   ...
		   jQuery('#browser_size_info').text('Viewport ( Width : '
			...
			//Customized view by developer because for fix properly display instead of simple view
			/*foreach ( $form['fields'] as $field ) {
            ...
            <tr>
                <td colspan="2">
                	<center><img id="loading_iframe" src="../wp-content/plugins/gravityforms/images/loading.gif" /></center>
                	<?php
					@session_start();
					$_SESSION['entry_view_lead'] = $lead;
					?>
                    <iframe id="idIframe" onload="iframeLoaded()" src="../?gf_page=entry_view&id=<?php echo $form['id'];?>" frameborder="1" vspace="0" hspace="0" marginheight="0" marginwidth="0" width="100%" height="100%"></iframe>
                    <script>
					function iframeLoaded() {
						  ...
						  if(iFrameID) {
								...
								iFrameID.height = "";
								iFrameID.height = (parseInt(iFrameID.contentWindow.document.body.scrollHeight)+20) + "px";
						  }   
					  }
					</script>
                </td>
