...
<style>
body{ margin:0px !important;padding:0px !important;background-color:#FFF !important;font-size:12px !important; }
label{ font-size:12px !important; }
div#preview_form_container{ border-bottom:0px !important; }
</style>
<body>
<div id="preview_top" style="display:none">
	<div id="preview_hdr">
		<div>
...
<div id="helper_legend_container" style="display:none">
	<ul id="helper_legend">
...
<div id="preview_form_container" style="display:none;margin:0px;padding:0px;">
	<span class="rule25"></span>
	<span class="rule33"></span>
	<span class="rule50"></span>
	<span class="rule66"></span>
	<span class="rule75"></span>
	<?php //echo RGForms::get_form( $form_id, false, false, true, null, false, 1, $lead, 1 ); ?>
    <?php echo RGForms::get_form( $form_id, false, false, true, null, false, 1, $lead, 1 ); ?>
</div>
...
<script>
jQuery("#preview_form_container").show();
window.parent.jQuery("#loading_iframe").hide();
</script>
</body>
</html>